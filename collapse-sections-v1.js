...
(()=>{
  ...
  const loadCloud=()=>{
    if(document.getElementById('trip-cloud-sync-v1-js'))return;
    const c=document.createElement('script');c.id='trip-cloud-sync-v1-js';c.src='/tokyo-winter-trip-2026/trip-cloud-sync-v1.js?v=1';c.defer=true;document.body.appendChild(c);
  };
  const load=()=>{
