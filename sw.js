...
const CORE=[BASE,BASE+'index.html',BASE+'manifest.webmanifest',BASE+'earth-icon-v14.svg',BASE+'plan-extras-v1.js',BASE+'plan-day-tools-v1.js',BASE+'disney-meta-v1.js',BASE+'map-theme-v1.css',BASE+'simple-map-v1.css'];
