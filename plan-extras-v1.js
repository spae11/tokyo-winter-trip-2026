(()=>{
  ...
  const trip=path.includes('/tokyo/')?'tokyo':path.includes('/hongkong/')?'hongkong':path.includes('/danang/')?'danang':path.includes('/yunnan/')?'yunnan':path.includes('/chongqing/')?'chongqing':null;
  if(!trip)return;
