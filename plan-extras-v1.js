(()=>{
  ...
  const trip=path.includes('/tokyo/')?'tokyo':path.includes('/hongkong/')?'hongkong':path.includes('/danang/')?'danang':path.includes('/yunnan/')?'yunnan':path.includes('/chongqing/')?'chongqing':path.includes('/harbin/')?'harbin':null;
  if(!trip)return;
